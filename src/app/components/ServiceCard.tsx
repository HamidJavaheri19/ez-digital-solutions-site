...
export function ServiceCard({ icon: Icon, title, description, delay = 0 }: ServiceCardProps) {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl p-8 border border-gray-border hover:border-[#5b7fc7]/30 transition-all duration-300 shadow-sm hover:shadow-2xl hover:shadow-[#5b7fc7]/10 overflow-hidden"
    >
      {/* Top accent line */}
